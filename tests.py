...
from scraper import MusicScraper, TrackListCreator, PlaylistPopulator
...
class TestWebScraper(unittest.TestCase):
    ...
    @patch('scraper.TrackListCreator._call_rdio_api_util')
    ...
    @patch('scraper.PlaylistPopulator._call_rdio_api_util')
    ...
    def test_create_playlist(self, my_rdio_search):
        ...
        self.assertEqual(result, 'Playlist created')
